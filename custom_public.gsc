main()
{
	...
	// assault
	setDvar( "weap_allow_m16", 10 );
	setDvar( "weap_allow_ak47", 10 );
	setDvar( "weap_allow_m4", 10 );
	setDvar( "weap_allow_g3", 10 );
	setDvar( "weap_allow_g36c", 10 );
	setDvar( "weap_allow_m14", 10 );
	setDvar( "weap_allow_mp44", 10 );
	...
	// smg
	setDvar( "weap_allow_mp5", 10 );
	setDvar( "weap_allow_uzi", 10 );
	setDvar( "weap_allow_ak74u", 10 );
	...
	// shotgun
	setDvar( "weap_allow_m1014", 10 );
	setDvar( "weap_allow_winchester1200", 10 );

	// sniper
	setDvar( "weap_allow_m40a3", 10 );
	setDvar( "weap_allow_remington700", 10 );

	// pistol
	setDvar( "weap_allow_beretta", 10 );
	setDvar( "weap_allow_colt45", 10 );
	setDvar( "weap_allow_usp", 10 );
	setDvar( "weap_allow_deserteagle", 10 );
	setDvar( "weap_allow_deserteaglegold", 10 );
	...
	setDvar( "g_maxDroppedWeapons", 32 ); // [2-32] (maximum number of dropped weapons before recycling)
	setDvar( "scr_hardcore", 0 ); // [0-1]

	// website
	setDvar( "promod_hud_website", "^5www.UnitedBandits.com" ); // (avoid "//" here)
